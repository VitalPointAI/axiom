...
def _row_to_tx(row) -> TransactionResponse:
    ...
    return TransactionResponse(
        ...
        timestamp=str(timestamp_iso) if timestamp_iso is not None else None,
        ...
        tax_category=str(tax_category) if tax_category is not None else None,
        sub_category=str(sub_category) if sub_category is not None else None,
        confidence_score=float(confidence_score) if confidence_score is not None else None,
        needs_review=bool(needs_review) if needs_review is not None else False,
        reviewer_notes=str(reviewer_notes) if reviewer_notes is not None else None,
