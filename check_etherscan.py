...
print(f"Fetching all transactions from Etherscan...")

# Normal transactions (V2 API)
response = requests.get(f'https://api.etherscan.io/v2/api', params={
    'chainid': 1,
    'module': 'account',
    'action': 'txlist',
    'address': address,
...
response2 = requests.get(f'https://api.etherscan.io/v2/api', params={
    'chainid': 1,
    'module': 'account',
